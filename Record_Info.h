...
typedef struct GenericRecordHeader {
  u_int32 RecordID;
  u_int32 RecordLength;         //  length of record to follow (in bytes), 
...
// special records used by builder/recorder
#define END_RUN_SIGNAL			0x454E4452UL	// 'ENDR' (empty record)
#define FILENAME_SIGNAL			0x464E414DUL	// 'FNAM' (followed by filename string)
...
#define SUB_TYPE_HCA_NEW       14UL     // calibrated data flags (one 32 bit word)
