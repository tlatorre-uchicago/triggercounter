...
#ifndef _MD5CHECKSUM_H
#define _MD5CHECKSUM_H
...
public:
	...
	char  * GetMD5();
	long    GetByteCount()      { return mByteCount;    }
	
	static char *   GetMD5(char *filename);
...
private:
	...
	char  m_MD5str[256];        //MD5 string
	long mByteCount;
	int mDidFinal;
};

#endif // _MD5CHECKSUM_H
